    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.SlugField(help_text='Identifier slug. e.g. anglechase.')),
                ('desc', models.CharField(help_text='Optional longer description.', max_length=200)),
                ('is_filter', models.BooleanField(default=True, help_text='Specifies whether users should use this tag to filter problems.Uncheck this for tags that are purely meant to be.used as umbrella parent tags and not as filters.')),
                ('parent', models.ForeignKey(blank=True, help_text='The parent tag that this tag comes under.Filtering by the parent tag filters by this tag too.If this field is blank, the is_filter option must be unchecked.', on_delete=django.db.models.deletion.PROTECT, related_name='children', to='vonty_app.tag')),
            ],
        ),
        migrations.CreateModel(
            name='Problem',
            fields=[
                ...
                ('hardness', models.PositiveIntegerField(blank=True, help_text='Hardness of the problem according to the MOHS scale.The rating can range from 0 to 60,and can be left blank if the problem is considered not-rateable.See https://web.evanchen.cc/upload/MOHS-hardness.pdffor more information.', null=True, validators=[django.core.validators.MaxValueValidator(60, 'MOHS rating cannot exceed 60'), django.core.validators.StepValueValidator(5, 'MOHS rating must be a multiple of 5')])),
                ...
                ('tags', models.ManyToManyField(help_text='The list of tags associated with the problem.', to='vonty_app.tag')),
            ],
        ),
    ]
